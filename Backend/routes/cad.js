...
router.post('/assign-unit', middleware.LoggedInMember, middleware.ProvideServerID, async (req, res) => {
...
router.post('/unit-status', middleware.LoggedInMember, middleware.ProvideServerID, async (req, res) => {
...
router.post('/calls', middleware.LoggedInMember, middleware.ProvideServerID, async (req, res) => {

    //TODO: CHECK DISPATCH PERMS
...
router.post('/deletecall', middleware.LoggedInMember, middleware.ProvideServerID, async (req, res) => {
    //TODO: CHECK DISPATCH PERMS
...
router.post('/del911', middleware.LoggedInMember, middleware.ProvideServerID, async (req, res) => {
