...
router.post('/settings/get', middleware.LoggedInMember, middleware.ProvideCommunity, async(req, res) => {
    if (await middleware.PermissionInCommunity(req, res, 'MANAGE_SETTINGS')) {
...
router.post('/settings/set', middleware.LoggedInMember, middleware.ProvideCommunity, async(req, res) => {
    if (await middleware.PermissionInCommunity(req, res, 'MANAGE_SETTINGS')) {
...
router.post('/settings/get-servers', middleware.LoggedInMember, middleware.ProvideCommunity, async(req, res) => {
    if (await middleware.PermissionInCommunity(req, res, 'MANAGE_SERVERS')) {
...
router.post('/settings/regen-server-secret', middleware.LoggedInMember, middleware.ProvideCommunity, async(req, res) => {
    if (await middleware.PermissionInCommunity(req, res, 'MANAGE_SERVERS')) {
...
router.post('/settings/add-server', middleware.LoggedInMember, middleware.ProvideCommunity, async(req, res) => {
    if (await middleware.PermissionInCommunity(req, res, 'MANAGE_SERVERS')) {
...
router.post('/settings/edit-server', middleware.LoggedInMember, middleware.ProvideCommunity, async(req, res) => {
    if (await middleware.PermissionInCommunity(req, res, 'MANAGE_SERVERS')) {
...
router.post('/settings/delete-server', middleware.LoggedInMember, middleware.ProvideCommunity, async(req, res) => {
    if (await middleware.PermissionInCommunity(req, res, 'MANAGE_SERVERS')) {
        const id = req.body.id
...
router.post('/settings/get-codes', middleware.LoggedInMember, middleware.ProvideCommunity, async(req, res) => {
    if (await middleware.PermissionInCommunity(req, res, 'MANAGE_CODES')) {
...
router.post('/settings/add-code', middleware.LoggedInMember, middleware.ProvideCommunity, async(req, res) => {
    if (await middleware.PermissionInCommunity(req, res, 'MANAGE_CODES')) {
...
router.post('/settings/delete-code', middleware.LoggedInMember, middleware.ProvideCommunity, async(req, res) => {
    if (await middleware.PermissionInCommunity(req, res, 'MANAGE_CODES')) {
        const id = req.body.id
...
router.post('/settings/get-permissions', middleware.LoggedInMember, middleware.ProvideCommunity, async(req, res) => {
    if (await middleware.PermissionInCommunity(req, res, 'MANAGE_MEMBERS')) {
...
router.post('/settings/set-permission', middleware.LoggedInMember, middleware.ProvideCommunity, async(req, res) => {
    if (await middleware.PermissionInCommunity(req, res, 'MANAGE_MEMBERS')) {
        const id = req.body.id
